...
class Nostalgia(IStrategy):
    ...
    buy_params = {
        ...
        "entry_condition_25_enable": True,
        "entry_condition_26_enable": True,
        "entry_condition_27_enable": True,
        "entry_condition_28_enable": True,
        "entry_condition_29_enable": True,
        "entry_condition_30_enable": True,
        "entry_condition_31_enable": True,
        #############
    }
    ...
    entry_condition_1_enable = buy_protection_params[1]["enable"]
    ...
    entry_condition_2_enable = buy_protection_params[2]["enable"]
    ...
    entry_condition_3_enable = buy_protection_params[3]["enable"]
    ...
    entry_condition_4_enable = buy_protection_params[4]["enable"]
    ...
    entry_condition_5_enable = buy_protection_params[5]["enable"]
    ...
    entry_condition_6_enable = buy_protection_params[6]["enable"]
    ...
    entry_condition_7_enable = buy_protection_params[7]["enable"]
    ...
    entry_condition_8_enable = buy_protection_params[8]["enable"]
    ...
    entry_condition_9_enable = buy_protection_params[9]["enable"]
    ...
    entry_condition_10_enable = buy_protection_params[10]["enable"]
    ...
    entry_condition_11_enable = buy_protection_params[11]["enable"]
    ...
    entry_condition_12_enable = buy_protection_params[12]["enable"]
    ...
    entry_condition_13_enable = buy_protection_params[13]["enable"]
    ...
    entry_condition_14_enable = buy_protection_params[14]["enable"]
    ...
    entry_condition_15_enable = buy_protection_params[15]["enable"]
    ...
    entry_condition_16_enable = buy_protection_params[16]["enable"]
    ...
    entry_condition_17_enable = buy_protection_params[17]["enable"]
    ...
    entry_condition_18_enable = buy_protection_params[18]["enable"]
    ...
    entry_condition_19_enable = buy_protection_params[19]["enable"]
    ...
    entry_condition_20_enable = buy_protection_params[20]["enable"]
    ...
    entry_condition_21_enable = buy_protection_params[21]["enable"]
    ...
    entry_condition_22_enable = buy_protection_params[22]["enable"]
    ...
    entry_condition_23_enable = buy_protection_params[23]["enable"]
    ...
    entry_condition_24_enable = buy_protection_params[24]["enable"]
    ...
    entry_condition_25_enable = buy_protection_params[25]["enable"]
    ...
    entry_condition_26_enable = buy_protection_params[26]["enable"]
    ...
    entry_condition_27_enable = buy_protection_params[27]["enable"]
    ...
    entry_condition_28_enable = buy_protection_params[28]["enable"]
    ...
    entry_condition_29_enable = buy_protection_params[29]["enable"]
    ...
    entry_condition_30_enable = buy_protection_params[30]["enable"]
    ...
    entry_condition_31_enable = buy_protection_params[31]["enable"]
    ...
    exit_condition_1_enable = CategoricalParameter([True, False], default=True, space='sell', optimize=False, load=True)
    exit_condition_2_enable = CategoricalParameter([True, False], default=True, space='sell', optimize=False, load=True)
    exit_condition_3_enable = CategoricalParameter([True, False], default=True, space='sell', optimize=False, load=True)
    exit_condition_4_enable = CategoricalParameter([True, False], default=True, space='sell', optimize=False, load=True)
    exit_condition_5_enable = CategoricalParameter([True, False], default=True, space='sell', optimize=False, load=True)
    exit_condition_6_enable = CategoricalParameter([True, False], default=True, space='sell', optimize=False, load=True)
    exit_condition_7_enable = CategoricalParameter([True, False], default=True, space='sell', optimize=False, load=True)
    exit_condition_8_enable = CategoricalParameter([True, False], default=True, space='sell', optimize=False, load=True)
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        if (last_candle is not None) & (previous_candle_1 is not None) & (previous_candle_2 is not None) & (previous_candle_3 is not None) & (previous_candle_4 is not None) & (previous_candle_5 is not None):
            ...
            # Sell signal 1
            if self.exit_condition_1_enable.value & (last_candle['rsi'] > self.sell_rsi_bb_1.value) & (last_candle['close'] > last_candle['bb20_2_upp']) & (previous_candle_1['close'] > previous_candle_1['bb20_2_upp']) & (previous_candle_2['close'] > previous_candle_2['bb20_2_upp']) & (previous_candle_3['close'] > previous_candle_3['bb20_2_upp']) & (previous_candle_4['close'] > previous_candle_4['bb20_2_upp']) & (previous_candle_5['close'] > previous_candle_5['bb20_2_upp']):
                return 'sell_signal_1'

            # Sell signal 2
            elif self.exit_condition_2_enable.value & (last_candle['rsi'] > self.sell_rsi_bb_2.value) & (last_candle['close'] > last_candle['bb20_2_upp']) & (previous_candle_1['close'] > previous_candle_1['bb20_2_upp']) & (previous_candle_2['close'] > previous_candle_2['bb20_2_upp']):
                return 'sell_signal_2'

            # Sell signal 3
            # elif (self.exit_condition_3_enable.value) & (last_candle['rsi'] > self.sell_rsi_main_3.value):
            #     return 'sell_signal_3'

            # Sell signal 4
            elif self.exit_condition_4_enable.value & (last_candle['rsi'] > self.sell_dual_rsi_rsi_4.value) & (last_candle['rsi_1h'] > self.sell_dual_rsi_rsi_1h_4.value):
                return 'sell_signal_4'

            # Sell signal 6
            elif self.exit_condition_6_enable.value & (last_candle['close'] < last_candle['ema_200']) & (last_candle['close'] > last_candle['ema_50']) & (last_candle['rsi'] > self.sell_rsi_under_6.value):
                return 'sell_signal_6'

            # Sell signal 7
            elif self.exit_condition_7_enable.value & (last_candle['rsi_1h'] > self.sell_rsi_1h_7.value) & (last_candle['crossed_below_ema_12_26']):
                return 'sell_signal_7'

            # Sell signal 8
            elif self.exit_condition_8_enable.value & (last_candle['close'] > last_candle['bb20_2_upp_1h'] * self.sell_bb_relative_8.value):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Buy Condition #1
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_1_enable']:
        ...
        # Buy Condition #2
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_2_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #3
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_3_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #4
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_4_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #5
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_5_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #6
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_6_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #7
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_7_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #8
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_8_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #9
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_9_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #10
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_10_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #11
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_11_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #12
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_12_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #13
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_13_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #14
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_14_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #15
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_15_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #16
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_16_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #17
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_17_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #18
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_18_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #19
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_19_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #20
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_20_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #21
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_21_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #22
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_22_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #23
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_23_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #24
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_24_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #25
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_25_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #26
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_26_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #27
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_27_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #28
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_28_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #29
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_29_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #30
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_30_enable']:
            # Non-Standard protections (add below)
        ...
        # Buy Condition #31
        # -----------------------------------------------------------------------------------------
        if self.buy_params['entry_condition_31_enable']:
            # Non-Standard protections (add below)
